...
touch 101-fix-mbedtls3.6-build.patch   
cat>101-fix-mbedtls3.6-build.patch<<EOF  
--- a/m4/mbedtls.m4
+++ b/m4/mbedtls.m4
...
mv 101-fix-mbedtls3.6-build.patch package/feeds/packages/shadowsocks-libev/patch/
